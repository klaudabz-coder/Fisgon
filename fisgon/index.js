                  ...
                  // Cargar comandos recursivamente Y GUARDAR CATEGORÍA
                    ...
                    for (const entry of entries) {
                      ...
                      if (entry.isDirectory()) {
                        ...
                        if (cmd && cmd.data && cmd.execute) {
                          ...
                          cmd.category = category; // Guardamos la categoría en el comando
                          // ------------------
                  ...
                  client.on('interactionCreate', async interaction => {
                    // Delegado: tenemos un evento interactionCreate en events/interactionCreate.js
                  });
